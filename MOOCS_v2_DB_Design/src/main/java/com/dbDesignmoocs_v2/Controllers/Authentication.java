...
//				}
	...
	@PostMapping("/register_learner")
	public String registerlearner(Model model,@ModelAttribute("learner")Learners learner,HttpSession session)
	{
		try {
			...
			Learners learn=this.lrRepository.save(learner);
